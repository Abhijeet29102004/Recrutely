...
const ExperienceModal = ({ onClose, onSave, existingData }) => {
  ...
  useEffect(() => {
    if (existingData) {
      // Map snake_case to camelCase for editing
      setFormData({
        role: existingData.role || "",
        company: existingData.company || "",
        startDate: existingData.start_date || existingData.startDate || "",
        endDate: existingData.end_date || existingData.endDate || "",
  ...
  const handleSubmit = () => {
    ...
    if (role && company && startDate ) {
      onSave({
        id: existingData?.id || formData.id ||Date.now(), // preserve ID for editing
        role,
        company,
        description,
